...
## Boss Fight
### The "Pre-Boss" area
In order to build up before a Boss battle, designers often create a "Pre-Boss" area where the player can basically recover and prepare for what would come next. The player could "feel" when they would have to face a Boss because of certain elements of level design, like save points just before entering a new area, conveniently placed Health recoveries or Weapons or arriving to a suspiciously large, empty room. 
